...
public class Equals extends Operation {
     ...
     */
    public Equals(List<Expression> expressionList) throws IllegalConstruction {
     ...
     * @return The result of the EQUALS operation, or a new MyNotANumber if either input number is a MyNotANumber or
